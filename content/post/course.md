...
- 但是无论用小数点厚多少位你们的轮子都不怎么好转(因为你们的轮毂是256边形的!)
- 你在CarOverflow上看到有人说π取3可以造出一个完美的**齿轮**, 你寻思这玩意儿和轮胎差不多都是圆的, 说服了队友问题是**小数点**导致的, 应该用**π = 3**才对
...
倒不是你们做的有多好, 而是你们是为数不多的能动的车子; 其他组能做个车子模型就算不错的了.
